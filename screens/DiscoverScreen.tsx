...
export default function DiscoverScreen() {
  ...
  const filteredListings = useMemo(() => {
    ...
    return trendingListings.filter((listing) => {
      return (
    ...
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      ...
      >
        <DGHeader
          ...
          onLocationPress={() => showComingSoon('Location settings')}
          secondaryAction={{
        ...
        <View style={styles.pageContent}>
          <DGSearchBar
            ...
            onSubmit={(query) => {
              ...
              Alert.alert('Search', `Searching Direct Gain for “${query}”.`);
            }}
          />
          ...
          <DGSection
            ...
            onActionPress={() => showComingSoon('Marketplace')}
          >
            {filteredListings.length > 0 ? (
              ...
              <DGCard variant="soft">
                <View style={styles.emptyState}>
                  ...
                  <Text style={styles.emptyTitle}>No local results</Text>
          ...
          <DGSection
            ...
            actionLabel="Explore"
            onActionPress={() => showComingSoon('Jobs')}
          >
            <View style={styles.verticalList}>
              {nearbyJobs.map((job) => (
                <JobPreviewCard
                  key={job.id}
                  job={job}
                  onPress={() => showComingSoon(job.title)}
                />
              ))}
            </View>
          </DGSection>
          ...
          <DGSection
            ...
            onActionPress={() => showComingSoon('Live Auctions')}
          >
            <View style={styles.verticalList}>
              {liveAuctions.map((auction) => (
                <AuctionPreviewCard
                  key={auction.id}
                  auction={auction}
                  onPress={() => showComingSoon(auction.title)}
                />
              ))}
            </View>
          </DGSection>
          ...
          <DGCard
            variant="raised"
            style={styles.createOpportunityCard}
          >
            ...
            <Text style={styles.createEyebrow}>GROW TOGETHER</Text>
            ...
            <Text style={styles.createDescription}>
              Sell an item, post a job, start an auction or share something
      ...
      <View style={styles.listingImagePlaceholder}>
        ...
        {listing.featured ? (
          <View style={styles.featuredBadge}>
            <Ionicons name="sparkles" size={11} color="#071004" />
      ...
      <View style={styles.listingContent}>
        ...
        <View style={styles.sellerRow}>
          ...
          <View style={styles.sellerDetails}>
            ...
            <Text style={styles.postedText}>{listing.postedAt}</Text>
          </View>

          <GainScoreBadge score={listing.gainScore} compact />
        </View>
      </View>
    </Pressable>
  );
  ...
  return (
    ...
    >
      ...
      <View style={styles.tagRow}>
        <InfoTag icon="cash-outline" label={job.pay} />
        <InfoTag icon="time-outline" label={job.workType} />
      </View>
      ...
      <View style={styles.cardBottomRow}>
        <View style={styles.locationDetails}>
          ...
          <Text numberOfLines={1} style={styles.metadataText}>
            {job.location} · {job.distance} · {job.postedAt}
          </Text>
        </View>

        <GainScoreBadge score={job.gainScore} compact />
      </View>
    </DGCard>
  );
}
...
function AuctionPreviewCard({
  ...
  return (
    <DGCard
      ...
      contentStyle={styles.compactCardContent}
    >
      <View style={styles.auctionTopRow}>
        <View style={styles.liveAuctionBadge}>
          <View style={styles.auctionLiveDot} />
          <Text style={styles.liveAuctionText}>LIVE</Text>
        </View>
        ...
        <View style={styles.timerBadge}>
          <Ionicons
            ...
            color={colors.primary}
          />
          <Text style={styles.timerText}>{auction.timeRemaining}</Text>
        </View>
      </View>

      <Text numberOfLines={2} style={styles.auctionTitle}>
        {auction.title}
      </Text>
      ...
      <View style={styles.bidRow}>
        ...
        <View style={styles.bidCountArea}>
      ...
      <View style={styles.cardBottomRow}>
        <View style={styles.locationDetails}>
          ...
          <Text numberOfLines={1} style={styles.metadataText}>
            {auction.sellerName} · {auction.location}
          </Text>
        </View>

        <GainScoreBadge score={auction.gainScore} compact />
      </View>
    </DGCard>
  );
}
...
function InfoTag({ icon, label }: InfoTagProps) {
  return (
    <View style={styles.infoTag}>
      ...
      <Text numberOfLines={1} style={styles.infoTagText}>
        {label}
      </Text>
    </View>
  );
